#!/usr/bin/env python3
"""把 mcp-main 分解出的原子注册到 Hermes 注册中心 v2。
...
DB_PATH = Path("/data/data/com.termux/files/home/hermes-data/agent.db")
...
def build_registry_atom(raw: Dict[str, Any]) -> Dict[str, Any]:
    ...
    atom: Dict[str, Any] = {
        ...
        "ownership": {
            "author": "mcp-main",
            "maintainer": "Hermes Registry",
            "team": "Hermes",
            "organization": "Hermes Atom Ecosystem",
