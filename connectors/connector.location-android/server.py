#!/usr/bin/env python3
"""Standard atom HTTP adapter for connector.location-android（连接原子）。
...
META = {
    "id": "connector.location-android",
    "name": "Android Location Connector",
    "type": "external",
    "version": "1.0.0",
    "author": "yuanzi",
    "builtin": False,
    "description": "封装 Android LocationManager，实现 schema.location-v1 接口标准",
    ...
    "input_schema": {"provider": "string (optional, gps|network|passive，默认 gps)"},
    "output_schema": {
