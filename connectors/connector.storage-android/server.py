#!/usr/bin/env python3
"""Standard atom HTTP adapter for connector.storage-android（连接原子）。
...
META = {
    "id": "connector.storage-android",
    "name": "Android Storage Connector",
    "type": "external",
    "version": "1.0.0",
    "author": "yuanzi",
    "builtin": False,
    "description": "封装 Android SAF / MediaStore，实现 schema.storage-v1 接口标准",
    "implements": "schema.storage-v1",
    "compatibility": {"os": "android", "manufacturer": "*", "hardware": []},
    "input_schema": {"tree_uri": "string (optional)", "limit": "integer (optional)"},
    "output_schema": {"status": "success|error", "data": {"files": "array"}},
}
