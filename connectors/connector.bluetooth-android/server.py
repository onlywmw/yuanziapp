#!/usr/bin/env python3
"""Standard atom HTTP adapter for connector.bluetooth-android（连接原子）。
...
META = {
    "id": "connector.bluetooth-android",
    "name": "Android Bluetooth Connector",
    "type": "external",
    "version": "1.0.0",
    "author": "yuanzi",
    "builtin": False,
    "description": "封装 Android BluetoothAdapter，实现 schema.bluetooth-v1 接口标准",
    "implements": "schema.bluetooth-v1",
    "compatibility": {"os": "android", "manufacturer": "*", "hardware": ["bluetooth"]},
    "input_schema": {"connected_only": "boolean (optional)"},
    "output_schema": {"status": "success|error", "data": {"devices": "array"}},
}
