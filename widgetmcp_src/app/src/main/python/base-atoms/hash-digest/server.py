#!/usr/bin/env python3
"""Standard atom HTTP adapter for system.hash-digest（基础原子，system 内置）。
...
META = {
    "id": "system.hash-digest",
    "name": "Hash Digest",
    "type": "function",
    "version": "1.0.0",
    "author": "system",
    "builtin": True,
    "description": "哈希计算（sha256/sha512/md5）",
    "input_schema": {"text": "string (required)", "algorithm": "sha256|sha512|md5"},
