#!/usr/bin/env python3
"""Standard atom HTTP adapter for system.http-get（基础原子，system 内置）。
...
META = {
    ...
    "author": "system",
    "builtin": True,
    "description": "HTTP GET（http/https 公网，max 100KB）",
    "input_schema": {"url": "string (required)", "headers": {}, "timeout": 30},
