#!/usr/bin/env python3
"""Standard atom HTTP adapter for system.ai（基础原子，system 内置）。
...
META = {
    ...
    "author": "system",
    "builtin": True,
    "description": "本地意图理解（规则兜底，可选 ONNX 增强）",
    "input_schema": {
        "query": "string（必填，自然语言）",
        "context": "object（可选，情境上下文）",
    },
    "output_schema": {
        "status": "success|error",
        "data": "{intent, params, matched_atoms, matched_workflows, confidence, source}",
    },
}
