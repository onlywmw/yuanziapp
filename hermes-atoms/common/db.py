...
DB_DIR = os.environ.get("HERMES_DB_DIR", "/opt/hermes/data")
...
def seed_capabilities() -> None:
    defaults = [
        ("browser/open", "atom", "hermes-browser", '{}', '{}'),
        ("browser/navigate", "atom", "hermes-browser", '{}', '{}'),
        ("browser/back", "atom", "hermes-browser", '{}', '{}'),
        ("browser/forward", "atom", "hermes-browser", '{}', '{}'),
        ("browser/reload", "atom", "hermes-browser", '{}', '{}'),
        ("widget/list", "atom", "hermes-widget", '{}', '{}'),
        ("deepseek/balance", "atom", "hermes-deepseek", '{}', '{}'),
        ("obsidian/card", "atom", "hermes-obsidian", '{}', '{}'),
    ]
    conn = sqlite3.connect(DB_PATH)
    cursor = conn.cursor()
