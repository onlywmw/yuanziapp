...
# -*- coding: utf-8 -*-
"""
Hermes Browser Atom - 浏览器能力原子
端口：8083
职责：
  1. 向 hermes-core 注册自己
...
ATOM_ID = "hermes-browser"
LABEL = "浏览器"
ATOM_TYPE = "browser"
PORT = int(os.environ.get("HERMES_BROWSER_PORT", "8083"))
HOST = os.environ.get("HERMES_BROWSER_HOST", "127.0.0.1")
