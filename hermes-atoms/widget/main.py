...
ATOM_ID = "hermes-widget"
LABEL = "Widget 组件"
ATOM_TYPE = "widget"
PORT = int(os.environ.get("HERMES_WIDGET_PORT", "8082"))
HOST = os.environ.get("HERMES_WIDGET_HOST", "127.0.0.1")
...
def register_with_core() -> bool:
    return http_post(
        f"{CORE_URL}/register",
        {
            ...
            "capabilities": ["widget/list", "widget/create", "widget/update"],
        },
    )
...
def main() -> None:
    ...
    server = ThreadingHTTPServer((HOST, PORT), WidgetHandler)
