...
# -*- coding: utf-8 -*-
"""
Yuanzi Obsidian Atom - Obsidian 笔记能力原子
端口：8085
"""
...
ATOM_ID = "yuanzi-obsidian"
LABEL = "Obsidian"
ATOM_TYPE = "note"
PORT = int(os.environ.get("YUANZI_OBSIDIAN_PORT", "8085"))
HOST = os.environ.get("YUANZI_OBSIDIAN_HOST", "127.0.0.1")
...
def register_with_core() -> bool:
    return http_post(
        f"{CORE_URL}/register",
        {
            ...
            "capabilities": ["obsidian/card", "obsidian/search"],
        },
    )
...
def main() -> None:
    ...
    server = ThreadingHTTPServer((HOST, PORT), ObsidianHandler)
